...
st.set_page_config(page_title="AirBnb-Analysis by NANCY!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 with col2:
    st.subheader("host_neighbourhood_ViewData")
